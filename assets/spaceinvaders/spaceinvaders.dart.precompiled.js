...
Interceptor: {"": "Object;",
  ...
  "%": "CanvasRenderingContext|CanvasRenderingContext2D|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList"
},
...
InputElement: {"": "HtmlElement;type=", "%": "HTMLInputElement"},
...
ObjectElement: {"": "HtmlElement;type=", "%": "HTMLObjectElement"},
...
DigitalInput: {"": "Object;",
  ...
  timeReleased$1: function(buttonId) {
    var t1, button;
    t1 = this.buttons;
    button = t1.$index(t1, buttonId);
    if (button == null)
      return 0;
    return button.get$timeReleased();
  },
  get$timeReleased: function() {
    return new H.BoundClosure$1(this, B.DigitalInput.prototype.timeReleased$1, null, "timeReleased$1");
  },
  ...
  _processMouseEvents$0: function() {
    ...
    for (t2 = this._mouseEvents, t3 = new H.ListIterator(t2, t2.length, 0, null); t3.moveNext$0();) {
      ...
      if (t5 === "mousemove") {
        ...
        t5.toString;
        if (document.webkitPointerLockElement === t5.gameLoop.element) {
...
PointerLock: {"": "Object;gameLoop,lockOnClick",
  ...
  PointerLock$1: function(gameLoop) {
    var t1, t2;
    t1 = C.EventStreamProvider_click.forElement$1(this.gameLoop.element);
...
["", "spaceinvaders.dart", , R, {
playGame: function() {
  var t1, canvasElement, context;
  t1 = $.game;
  if (t1 == null || t1.gameOver === true) {
    t1 = $.gameLoop;
    if (t1 != null)
      t1.stop$0(t1);
    canvasElement = document.querySelector("canvas");
    context = J.get$context2D$x(canvasElement);
    $.gameLoop = G.GameLoopHtml$(canvasElement);
    $.game = R.Game$(context);
    t1 = $.gameLoop;
    t1.onUpdate = new R.playGame_closure();
    t1.onRender = new R.playGame_closure0();
    t1.start$0(t1);
  }
},

main: function() {
  var canvasElement, t1, t2;
  canvasElement = document.querySelector("canvas");
  J.get$context2D$x(canvasElement).strokeText("CLICK TO PLAY GAME\nControls:\nMove left and right, space to shoot.", 50, 50);
  t1 = C.EventStreamProvider_click.forElement$1(canvasElement);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.main_closure()), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
},

boxesAreColliding: function(box1, box2) {
  var xIntersects, yIntersects;
  xIntersects = J.$ge$n(box1.$index(box1, "x"), J.$sub$n(box2.$index(box2, "x"), box1.$index(box1, "width"))) && J.$le$n(box1.$index(box1, "x"), J.$add$ns(box2.$index(box2, "x"), box2.$index(box2, "width")));
  yIntersects = J.$ge$n(box1.$index(box1, "y"), J.$sub$n(box2.$index(box2, "y"), box1.$index(box1, "height"))) && J.$le$n(box1.$index(box1, "y"), J.$add$ns(box2.$index(box2, "y"), box2.$index(box2, "height")));
  return xIntersects && yIntersects;
},

playGame_closure: {"": "Closure;",
  call$1: function(gameLoop) {
    var keys, timeSpaceReleased;
    keys = H.fillLiteralMap(["left", gameLoop.get$keyboard().isDown$1(37), "right", gameLoop._keyboard.isDown$1(39)], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    timeSpaceReleased = gameLoop._keyboard.timeReleased$1(32);
    $.game.move$5(gameLoop._frameCounter, gameLoop._gameTime, gameLoop.updateTimeStep, keys, timeSpaceReleased);
  },
  $is_args1: true
},

playGame_closure0: {"": "Closure;",
  call$1: function(gameLoop) {
    $.game.draw$1(gameLoop.get$renderInterpolationFactor());
  },
  $is_args1: true
},
...
Game: {"": "Object;context,onScreen,bullets,monsters,player,lastTimeShot,monsterLastSpawned,shot,gameOver,firstMove,fireRate",
  move$5: function(frame, time, dt, keys, timeSpaceReleased) {
    var t1, t2, monster, t3, t4, bullet, shotMonsters, bulletsHit, m, b, movedOffScreen, entity;
    for (t1 = this.onScreen, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
      t1._current.move$1(keys);
    ...
    if (this.firstMove === true) {
      ...
      t1 = this.lastTimeShot;
      if (typeof timeSpaceReleased !== "number")
        throw timeSpaceReleased.$sub();
      if (typeof t1 !== "number")
        throw H.iae(t1);
      t2 = this.fireRate;
      if (typeof t2 !== "number")
        throw H.iae(t2);
      this.shot = timeSpaceReleased - t1 > t2;
    }
    t1 = this.monsterLastSpawned;
    if (t1 != null) {
      t2 = C.JSNumber_methods.toInt$0(time);
      if (typeof t1 !== "number")
        throw t1.$lt();
      t2 = t1 < t2;
      t1 = t2;
      ...
      t1 = true;
    if (t1) {
      $.get$randomGen().toString;
      monster = new R.Monster(null, null, 10, 10, null, null);
      monster.Entity$3(Math.random() * 340 + 30, 350, 3.141592653589793);
      monster.width = 20;
      monster.height = 20;
      this.monsters.push(monster);
      this.onScreen.push(monster);
      this.monsterLastSpawned = C.JSNumber_methods.toInt$0(time);
    }
    if (this.shot === true) {
      t1 = this.player;
      t2 = t1.x;
      ...
      if (typeof t4 !== "number")
        throw t4.$add();
      bullet = new R.Bullet(null, null, 10, 10, null, null);
      bullet.Entity$3(t2 + 0.5 * t3, t4 + t1, 3.141592653589793);
      bullet.width = 1;
      bullet.height = 1;
      this.onScreen.push(bullet);
      this.bullets.push(bullet);
      this.lastTimeShot = timeSpaceReleased;
    }
    if (this.player.isEaten$1(this.monsters)) {
      J.remove$1$ax(this.onScreen, this.player);
      this.gameOver = true;
    }
    shotMonsters = [];
    bulletsHit = [];
    for (t1 = this.monsters, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
      m = t1._current;
      for (t2 = this.bullets, t2 = new H.ListIterator(t2, t2.length, 0, null); t2.moveNext$0();) {
        b = t2._current;
        if (m.isShotBy$1(b)) {
          J.remove$1$ax(this.onScreen, m);
          J.remove$1$ax(this.onScreen, b);
          shotMonsters.push(m);
          bulletsHit.push(b);
        }
      }
    }
    for (t1 = new H.ListIterator(shotMonsters, shotMonsters.length, 0, null); t1.moveNext$0();) {
      m = t1._current;
      J.remove$1$ax(this.monsters, m);
    }
    for (t1 = new H.ListIterator(bulletsHit, bulletsHit.length, 0, null); t1.moveNext$0();) {
      b = t1._current;
      J.remove$1$ax(this.bullets, b);
    }
    movedOffScreen = [];
    for (t1 = this.onScreen, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
      entity = t1._current;
      ...
      if (!(t3 < 0 || t3 > 400)) {
        ...
        t2 = true;
      if (t2)
        movedOffScreen.push(entity);
    }
    for (t1 = new H.ListIterator(movedOffScreen, movedOffScreen.length, 0, null); t1.moveNext$0();) {
      entity = t1._current;
      J.remove$1$ax(this.onScreen, entity);
      if (J.contains$1$asx(this.bullets, entity))
        J.remove$1$ax(this.bullets, entity);
      if (J.contains$1$asx(this.monsters, entity))
        J.remove$1$ax(this.monsters, entity);
    }
  },
  draw$1: function(interpolationFactor) {
    var t1;
    this.context.clearRect(0, 0, 400, 400);
    for (t1 = this.onScreen, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
      t1._current.draw$1(this.context);
    if (this.gameOver === true)
      this.context.strokeText("Game Over", 50, 50);
  },
  Game$1: function(context) {
    ...
    this.bullets = [];
    this.monsters = [];
    t1 = new R.Box(null, null, 10, 10, null, null);
    t1.Entity$3(50, 50, 0.7853981633974483);
    this.player = t1;
    this.onScreen.push(this.player);
    this.lastTimeShot = 0;
    this.monsterLastSpawned = null;
    this.shot = false;
    this.gameOver = false;
    this.firstMove = true;
    this.fireRate = 0.5;
...
Game$: function(context) {
  var t1 = new R.Game(null, null, null, null, null, null, null, null, null, null, null);
  t1.Game$1(context);
  return t1;
}}
...
Entity: {"": "Object;x>,y>",
  outlineMap$0: function() {
    return H.fillLiteralMap(["x", this.x, "y", this.y, "width", this.width, "height", this.height], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
  },
  draw$1: function(context) {
    context.strokeRect(this.x, this.y, this.width, this.height);
  },
  move$1: function(keys) {
    var t1, t2, t3;
    t1 = this.x;
    t2 = this.speed;
    t3 = this.facingAngle;
  ...
  Entity$3: function(x, y, facingAngle) {
    this.x = x;
    this.y = y;
...
Box: {"": "Entity;x,y,width,height,facingAngle,speed",
  move$1: function(keys) {
    var t1;
    if (keys.$index(keys, "left") === true) {
      t1 = this.x;
      if (typeof t1 !== "number")
        throw t1.$lt();
      t1 = !(t1 < 30);
  ...
  isEaten$1: function(monsters) {
    var t1;
    for (t1 = new H.ListIterator(monsters, monsters.length, 0, null); t1.moveNext$0();)
      if (R.boxesAreColliding(t1._current.outlineMap$0(), H.fillLiteralMap(["x", this.x, "y", this.y, "width", this.width, "height", this.height], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null))))
        return true;
    return false;
  }
},

Bullet: {"": "Entity;x,y,width,height,facingAngle,speed",
  draw$1: function(context) {
    context.strokeRect(this.x, this.y, this.width, this.height);
  },
  move$1: function(keys) {
...
Monster: {"": "Entity;x,y,width,height,facingAngle,speed",
  draw$1: function(context) {
    context.strokeRect(this.x, this.y, this.width, this.height);
  },
  move$1: function(keys) {
  ...
  isShotBy$1: function(bullet) {
    if (R.boxesAreColliding(bullet.outlineMap$0(), this.outlineMap$0()))
      return true;
    return false;
  }
}},
...
Isolate.$lazy($, "randomGen", "randomGen", "get$randomGen", function() {
  return C.C__Random;
});
// Native classes
...
function dart_precompiled($collectedClasses) {
  ...
  DigitalButton.prototype.get$timeReleased = function() {
  ...
  function playGame_closure() {
  }
  playGame_closure.builtin$cls = "playGame_closure";
  if (!"name" in playGame_closure)
    playGame_closure.name = "playGame_closure";
  $desc = $collectedClasses.playGame_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  playGame_closure.prototype = $desc;
  function playGame_closure0() {
  }
  playGame_closure0.builtin$cls = "playGame_closure0";
  if (!"name" in playGame_closure0)
    playGame_closure0.name = "playGame_closure0";
  $desc = $collectedClasses.playGame_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  playGame_closure0.prototype = $desc;
  ...
  function Game(context, onScreen, bullets, monsters, player, lastTimeShot, monsterLastSpawned, shot, gameOver, firstMove, fireRate) {
    this.context = context;
    ...
    this.monsterLastSpawned = monsterLastSpawned;
    this.shot = shot;
  ...
  function Box(x, y, width, height, facingAngle, speed) {
    this.x = x;
    this.y = y;
    this.width = width;
    this.height = height;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Box.prototype = $desc;
  function Bullet(x, y, width, height, facingAngle, speed) {
    this.x = x;
    this.y = y;
    this.width = width;
    this.height = height;
  ...
  function Monster(x, y, width, height, facingAngle, speed) {
    this.x = x;
    this.y = y;
    this.width = width;
    this.height = height;
  ...
  Monster.builtin$cls = "Monster";
  if (!"name" in Monster)
    Monster.name = "Monster";
  $desc = $collectedClasses.Monster;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Monster.prototype = $desc;
